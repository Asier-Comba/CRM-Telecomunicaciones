...
if (!proof || !API) { console.error('Faltan N8N_API_KEY / N8N_API_URL en .env.local'); process.exit(2) }
...
const r = await fetch(`${API}/workflows/${WF_ID}`, { headers: { 'X-N8N-API-KEY': proof, accept: 'application/json' } })
