...
if (!proof || !apiBase) { console.error('Faltan N8N_API_KEY / N8N_API_URL|N8N_BASE_URL'); process.exit(2) }
const H = { 'X-N8N-API-KEY': proof, accept: 'application/json', 'Content-Type': 'application/json' }
