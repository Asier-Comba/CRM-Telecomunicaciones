...
if (!proof || !API) { console.error('Faltan N8N_API_KEY / N8N_API_URL|N8N_BASE_URL en .env.local'); process.exit(2) }

const H = { 'X-N8N-API-KEY': proof, 'Content-Type': 'application/json', accept: 'application/json' }
